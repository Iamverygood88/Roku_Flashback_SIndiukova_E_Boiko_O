...
--
-- Host: localhost:8889
-- Generation Time: Apr 07, 2020 at 10:55 PM
...
INSERT INTO `tbl_movies` (`id`, `movie_cover`, `movie_title`, `movie_year`, `movie_runtime`, `movie_storyline`, `movie_trailer`, `movie_release`, `age_appropriateness`) VALUES
(1, 'cinderella_1950.jpg', 'Cinderella', '1950', '1h 16m', 'When Cinderella\'s dream of attending the Royal Ball and meeting the Grand Duke is hindered by her cruel stepmother, she gets some astounding help from her Fairy Godmother.', 'Cinderella Trailer (1950).mp4', '‎February 15‎, ‎1950', 'G'),
...
(6, 'problem_child_1990.jpg', 'Problem Child', '1990', '1h 21m', 'Ben Healy and his wife decide to adopt Junior, a seven-year-old boy, when they are unable to conceive. Soon, Junior reveals his mischievous nature that drives his adoptive parents crazy.', 'Problem Child   (1990) .mp4', 'July 27, 1990', 'G'),
(7, 'home_alone_1990.jpg', 'Home Alone', '1990', '1h 43m', 'Eight-year-old Kevin is accidentally left behind when his family leaves for France. At first, he is happy to be in charge, but when thieves try to break into his home, he tries to put up a fight.', 'Home Alone_1990 .mp4', ' November 16, 1990', 'G'),
...
(6, 'rubber_duckie_1970.jpg', 'Rubber Duckie', '2min', '\"Rubber Duckie\" is a song sung by the Muppet character Ernie (voiced by Jim Henson) on Sesame Street. The song is named after Ernie\'s toy, a rubber duck affectionately named Rubber Duckie.', '1970', 'K'),
(7, 'hooley_dooleys_1990.jpg', 'Hooley Dooleys', '1hr', 'The Hooley Dooleys were an Australian children\'s music and performance act which began in 1996. Their material was aimed at children between the ages of two and seven. They originally appeared on the Australian Broadcasting Corporation, but then appeared on commercial television and as a live touring act.', '1996', 'K'),
(8, 'bowie_1980.jpg', 'David Bowie - The Best of David Bowie 1980/1987', '1hr 17min', 'The Best of David Bowie 1980/1987 is a compilation album by David Bowie. The CD was originally released by EMI as part of The Platinum Collection in 2005/2006. The 2007 release is part of EMI\'s two-disc Sight & Sound series, each of which features a CD and DVD of material from the same artist. The DVD portion of the collection features two videos previously unreleased on DVD - \"When the Wind Blows\" and \"The Drowned Girl\".', '19 March 2007', 'A&K'),
(9, 'frank_sinatra_1950_adult.jpg', 'Sing and Dance with Frank Sinatra', '50min', 'Swing and Dance with Frank Sinatra is the sixth studio album by Frank Sinatra. ', 'October 16, 1950', 'A'),
(10, 'ac_dc_1980_adult.jpg', 'AC/DC - Back in Black', '42min', 'Back in Black is the seventh studio album by Australian rock band AC/DC. It was released on 25 July 1980 by Albert Productions and Atlantic Records. It is the band\'s first album to feature vocalist Brian Johnson, following the death of previous vocalist Bon Scott.', '25 July 1980', 'A'),
...
(12, 'elvis_1960_adult.jpg', 'Elvis Presley - His Hand in Mine', '28', 'His Hand in Mine is the fifth studio album by American singer and musician Elvis Presley, released on RCA Victor Records in mono and stereo, LPM/LSP 2328, in November 1960. It was the first of three gospel music albums that Presley would issue during his lifetime.', 'November 10, 1960', 'A');
...
CREATE TABLE `tbl_television` (
  ...
  `television_trailer` varchar(75) NOT NULL,
...
INSERT INTO `tbl_television` (`id`, `television_cover`, `television_title`, `television_year`, `television_runtime`, `television_storyline`, `television_trailer`, `television_release`, `age_appropriateness`) VALUES
(1, 'tiny_toon_adventures_1990.jpg', 'Tiny Toon Adventures', '1990', '3 seasons', 'A new generation of young cartoon characters attends Acme Acres Looniversity, where they embark on a series of off-the-wall adventures while learning the basics of comedy from their Looney Tunes mentors. Popular characters include Buster Bunny, Babs Bunny, Plucky Duck, Hamton J. Pig, Fifi La Fume, Dizzy Devil, Calamity Coyote, Sweetie Bird, and two human characters, Elmyra Duff and Montana Max, who are regarded as the main villains of the series.', '', 'September 14, 1990', 'G'),
(2, 'the_new_adventures_of_winnie_1980.jpg', 'The New Adventures of Winnie the Pooh', '1988', '30min', 'Follow Winnie the Pooh\'s adventures in the Hundred Acre Wood.', '', 'January 17, 1988', 'G'),
(3, 'mickey_mouse_club_1950.jpg', 'The Mickey Mouse Club', '1955', '1h', 'Mickey Mouse is the host of this variety show with a club attended by a variety of kids being the Mouseketeers. The usual content includes in-studio comedy and musical acts by those kids, classic as well as original cartoons and dramatic serials like \"Spin and Marty\" and \"The Hardy Boys.\"', '', '17 July 1955', 'G'),
...
(5, 'groovie_goolies_1970.jpg', 'Groovie Goolies', '1970', '1h', 'The adventures of the residents of a haunted boarding house for monsters.', '', '12 September 1970', 'G'),
(6, 'garfield_1980.jpg', 'Garfield and Friends', '1988', '30min', 'Stories about Garfield the cat, Odie the dog, their owner Jon and the trouble they get into, and Orson the Pig and his adventures on a farm with fellow farm animals.', '', 'September 17, 1988', 'G'),
(7, 'flintstones_1960.jpg', 'The Flintstones', '1960', '30min', 'The Flintstones were the modern Stone Age family. Residing in Bedrock, Fred Flintstone worked an unsatisfying quarry job, but returned home to lovely wife Wilma and eventually daughter Pebbles. Fred, a big fan of golf and bowling, also enjoyed bullying neighbor Barney Rubble, while Barney\'s saucy wife Betty was best friends with Wilma. During the show\'s run, Barney and Betty would adopt an unnaturally strong son, Bamm-Bamm, who would become friends with little Pebbles. \"The Flintstones,\" heavily inspired by \"The Honeymooners,\" convinced a generation of children that dinosaurs and humans occupied the planet at the same time.', '', '29 October 1964', 'G'),
(8, 'alvin_and_the_chipmunks_1980.jpg', 'Alvin & the Chipmunks', '1983', '30min', 'Three chipmunk brothers, Alvin, Simon, and Theodore. The trio have been adopted by and are living with Dave (human). Each show finds the boys getting into trouble and new and unusual situations.', '', '17 September 1983', 'G'),
(9, 'jack_benny_show_1950_adult.jpg', 'The Jack Benny Program', '1950', '30min', 'The comic misadventures of the \"skinflint\" comedian and his friends.', '', '28 October 1950', 'PG'),
(10, 'andy_1960_adult.jpg', 'The Andy Griffith Show', '1960', '30min', 'Widower Sheriff Andy Taylor, and his son Opie, live with Andy\'s Aunt Bee in Mayberry, North Carolina. With virtually no crimes to solve, most of Andy\'s time is spent philosophizing and calming down his cousin Deputy Barney Fife.', '', '3 October 1960', 'PG'),
(11, 'mary_tyler_moore_1970_adult.jpg', 'Mary Tyler Moore', '1970', '30min', 'The lives and trials of a young single woman and her friends, both at work and at home.', '', '19 September 1970', 'PG'),
(12, 'cheers_1980_adult.jpg', 'Cheers', '1982', '22min', 'The regulars of the Boston bar \"Cheers\" share their experiences and lives with each other while drinking or working at the bar where everybody knows your name.', '', ' 30 September 1982', 'PG'),
(13, 'twin_peaks_1990_adult.jpg', 'Twin Peaks ', '1990', '47min', 'An idiosyncratic FBI agent investigates the murder of a young woman in the even more idiosyncratic town of Twin Peaks.', '', '8 April 1990', 'PG'),
(14, 'fresh_prince_of_bel-air_1990_adult.jpg', 'The Fresh Prince of Bel-Air ', '1990', '22min', 'A streetwise, poor young man from Philadelphia is sent by his mother to live with his aunt, uncle and cousins in their Bel-Air mansion.', '', '10 September 1990', 'PG'),
(15, 'law_order_1990_adult.jpg', 'Law & Order ', '1990', '45min', 'Follows a crime (usually a murder), usually adapted from current headlines, from two separate vantage points, the police investigation and the prosecution in court.', '', '13 September 1990', 'PG'),
(16, 'beverly_hills_90210_adult.jpg', 'Beverly Hills, 90210 ', '1990', '44min', 'A group of friends living in Beverly Hills, California make their way through life from their school days into adulthood.', '', '4 October 1990', 'PG');
...
INSERT INTO `tbl_user` (`id`, `user_name`, `user_surname`, `avatar`, `user_pass`) VALUES
(1, 'Mom', 'Smith', 'mom.jpg', 'Boss'),
(2, 'Emily', 'Kid', 'girl.jpg', 'Teen');

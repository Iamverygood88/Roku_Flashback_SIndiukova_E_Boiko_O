...
export default {
    ...
    <form id="my-form" @submit.prevent="updateTableTV">
    <div class="border-input">
    <label for="movie_title">Enter TV Name:</label>
    <input name="movie_title" id="border-inp" type="text"  placeholder="TV Title" class="text" required>
    </div>
    <div class="border-input">
    ...
    let url = "./admin/update_table.php?update_table_tv=true";

...
export default {
    ...
    <form id="my-form" @submit.prevent="updateTable">
    <div class="border-input">
    <label for="movie_title">Enter Movie Name:</label>
    <input name="movie_title" id="border-inp" type="text"  placeholder="Movie Title" class="text" required>
    </div>
    <div class="border-input">
    ...
    let url = "./admin/update_table.php?update_table=true";
